...
public class patientProfileTest3 {
    @Rule
    ...
    @Test
    @UiThreadTest
    public void checkText2() throws Exception {
        assertNotNull(mActivity.findViewById(R.id.textView38));
        text = mActivity.findViewById(R.id.textView36);
        text.setText("User1");
